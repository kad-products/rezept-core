...
export default function GrowingZoneSeasonsLoadForm({ growingZoneId }: { growingZoneId: string }): React.ReactNode {
	...
	async function handleSubmit(e: React.FormEvent): Promise<void> {
		...
		try {
			...
			const res = await fetch(`/api/growing-zones/${growingZoneId}/seasons-load`, {
				method: 'POST',
				body: formData,
			});
